...
export interface ApiMedicineCategorieMedicineCategorie
  extends Struct.CollectionTypeSchema {
  collectionName: 'medicine_categories';
  info: {
    displayName: 'Medicine_Categorie';
    pluralName: 'medicine-categories';
    singularName: 'medicine-categorie';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    CategoryID: Schema.Attribute.UID & Schema.Attribute.Required;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::medicine-categorie.medicine-categorie'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiMedicineMedicine extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    medicine_categorie: Schema.Attribute.Relation<
      'oneToOne',
      'api::medicine-categorie.medicine-categorie'
    >;
    MedicineID: Schema.Attribute.UID & Schema.Attribute.Required;
    Meds: Schema.Attribute.Component<'medicine-details.med', true>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiPurchaseOrderLinePurchaseOrderLine
  ...
  attributes: {
    ...
    OrderLineID: Schema.Attribute.UID & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    ...
    >;
    UnitPriceAtOrder: Schema.Attribute.Integer;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiPurchaseOrderPurchaseOrder
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    Order: Schema.Attribute.Component<'order-summary.order', true>;
    ...
    SupplierID: Schema.Attribute.UID & Schema.Attribute.Required;
...
export interface ApiStockInventoryStockInventory
  ...
  attributes: {
    ...
    InventoryID: Schema.Attribute.UID & Schema.Attribute.Required;
    ...
    Stock: Schema.Attribute.Component<'storage-info.stock', true>;
...
export interface ApiSupplierSupplier extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Contact: Schema.Attribute.Component<'contact-info.infos', true>;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::medicine-categorie.medicine-categorie': ApiMedicineCategorieMedicineCategorie;
